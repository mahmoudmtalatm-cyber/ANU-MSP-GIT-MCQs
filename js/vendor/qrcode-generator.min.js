/* qrcode-generator v2.0.4 — https://github.com/kazuhikoarase/qrcode-generator
   ...
   Vendored locally (build 70) so QR generation for P2P transfer codes never
   depends on a CDN being reachable. Minified with terser, behavior
   unchanged from upstream. Exposes a global `qrcode(typeNumber, errorCorrectionLevel)`. */
