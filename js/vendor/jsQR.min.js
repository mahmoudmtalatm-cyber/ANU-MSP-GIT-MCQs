/* jsQR v1.4.0 — https://github.com/cozmo/jsQR
   Copyright (c) 2017 Cosmo Wolfe. Apache License 2.0.
   Vendored locally (build 70) so QR scanning for P2P transfer codes never
   depends on a CDN being reachable. Minified with terser, behavior
   unchanged from upstream. Exposes a global `jsQR(data, width, height)`. */
