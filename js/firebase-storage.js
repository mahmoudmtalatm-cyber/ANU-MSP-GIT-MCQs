      ...
      html += `<div class="cq-quiz-item" style="background:var(--surface-2);border:1.5px solid var(--accent);">
        ...
        <div class="cq-quiz-actions">
          ...
          <div class="cq-move-wrap">
            <button class="cq-btn cq-btn-secondary" id="cqBulkMoveBtn" style="background:var(--violet-strong);" onclick="cqToggleBulkMoveMenu()">📁 Move to…</button>
    ...
    visibleQuizzes.forEach(q => {
      ...
      html += `<div class="cq-quiz-item" draggable="true"
        ...
        <div class="cq-quiz-actions">
          ...
          <div class="cq-move-wrap">
            <button class="cq-btn cq-btn-secondary" data-move-btn="${q.id}" style="background:var(--violet-strong);" onclick="cqToggleQuizMoveMenu('${q.id}')" title="Move to a folder">📁 Move</button>
